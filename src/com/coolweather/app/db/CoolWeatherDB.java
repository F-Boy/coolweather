...
public class CoolWeatherDB {
	...
	public List<City> loadCity(int provinceId) {
		...
		Cursor crusor = db.query("City", null, "provinceId=?",
				new String[] { String.valueOf(provinceId) }, null, null, null);
		if (crusor.moveToFirst()) {
			do {
				City city = new City();
				city.setId(crusor.getInt(crusor.getColumnIndex("id")));
				city.setCityName(crusor.getString(crusor
						.getColumnIndex("city_name")));
				city.setCityCode(crusor.getString(crusor
